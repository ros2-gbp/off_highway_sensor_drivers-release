...
%global pkg_name off_highway_mm7p10_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-off-highway-mm7p10-msgs
Version:        1.3.0
Release:        3%{?dist}
...
%description
The off_highway_mm7p10_msgs package
...
%changelog
* Wed Apr 29 2026 Darius Man <darius.man@ro.bosch.com> - 1.3.0-3
- Autogenerated by Bloom

* Wed Apr 29 2026 Darius Man <darius.man@ro.bosch.com> - 1.3.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Darius Man <darius.man@ro.bosch.com> - 1.3.0-1
- Autogenerated by Bloom
