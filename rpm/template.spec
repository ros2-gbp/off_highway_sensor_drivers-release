...
%global pkg_name off_highway_general_purpose_radar_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-off-highway-general-purpose-radar-msgs
Version:        1.3.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Sarah Huber <sarah.huber@de.bosch.com> - 1.3.0-3
- Autogenerated by Bloom

* Wed Apr 29 2026 Sarah Huber <sarah.huber@de.bosch.com> - 1.3.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Sarah Huber <sarah.huber@de.bosch.com> - 1.3.0-1
- Autogenerated by Bloom
